...
import type { Campo, Opcao, Regra } from "@/lib/formulario-schema";
...
export function EditorCampo({
  ...
  const podeTerOpcoes = ["radio", "select", "checkbox"].includes(campo.tipo);
  ...
  return (
    <div className="flex flex-col gap-6">
      <label className="flex flex-col gap-1.5 text-sm">
        <span className="text-zinc-400">Pergunta</span>
